...
const ContactSection: React.FC = () => {
  ...
  return (
    <section className="mt-20 md:mt-40 flex flex-col gap-10">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-16 items-center px-8 md:px-0 overflow-hidden">
        <motion.form
          ref={formRef}
        ...
        >
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div>
              ...
              <input
                ...
                className="shadow-sm bg-secondary  text-gray-300 text-sm rounded-lg  block w-full p-3.5 focus:ring-0 focus:outline-none"
          ...
          <div className="sm:col-span-2">
            ...
            <textarea
              ...
              className="bg-secondary block p-3.5 w-full text-sm text-gray-300 rounded-lg shadow-sm focus:ring-0 focus:outline-none"
          ...
          <button
            type="submit"
            className="py-3 px-5 text-xl font-bold text-center text-white rounded-lg bg-tertiary sm:w-fit hover:bg-secondary focus:ring-4 focus:outline-none"
          >
            Send Message
          </button>
        </motion.form>
